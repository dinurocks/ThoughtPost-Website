...
export const updateProfileInfo=(id,name,email,mobile) => {
    return axios.get(baseURL+"updateProfileInfo", {params:{id,name,email,mobile}});
} 
...
export const updateUserFollowingName=(id,name) => {
    return axios.get(baseURL+"updateUserFollowingName", {params:{id,name}});
} 
